...
Of these, twelve are emitted (BROKEN_REFERENCE, SELF_COMPOSITION,
...
DESCRIPTION_BODY_GAP) and two are abstained with documented reasons
(CHECK_WITHOUT_ORACLE, CLAIM_WITHOUT_PROVENANCE). Abstention is
